      ...
      <header className="bg-slate-900/40 backdrop-blur-xl sticky top-0 z-50 border-b border-white/5 px-6 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-gradient-to-tr from-indigo-600 to-purple-500 p-1.5 rounded-xl shadow-lg ring-1 ring-white/20">
              <img src="/logo.png" alt="MemeGenie Logo" className="w-8 h-8 rounded-lg object-contain" />
            </div>
